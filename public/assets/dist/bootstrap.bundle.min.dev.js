  ...
  for (var X = function () {
    ...
    var t = "carousel",
      ...
      return h.next = function () {
        ...
        if (!(t > this._items.length - 1 || t < 0)) if (this._isSliding) e(this._element).one(l.SLID, function () {
          return n.to(t);
        });else {
        ...
        if (t === a.NEXT ? (i = c.LEFT, r = c.NEXT, o = a.LEFT) : (i = c.RIGHT, r = c.PREV, o = a.RIGHT), d && e(d).hasClass(c.ACTIVE)) this._isSliding = !1;else if (!this._triggerSlideEvent(d, o).isDefaultPrevented() && h && d) {
        ...
        return this.each(function () {
          ...
          if (i || (i = new r(this, s), e(this).data(n, i)), "number" == typeof t) i.to(t);else if ("string" == typeof a) {
      ...
      return f.toggle = function () {
        ...
        if (!this._isTransitioning && e(this._element).hasClass(a.SHOW)) {
          ...
          if (e(this._element).trigger(n), !n.isDefaultPrevented()) {
            ...
            if (this._element.style[i] = this._element.getBoundingClientRect()[i] + "px", X.reflow(this._element), e(this._element).addClass(a.COLLAPSING).removeClass(a.COLLAPSE).removeClass(a.SHOW), this._triggerArray.length) for (var r = 0; r < this._triggerArray.length; r++) {
        ...
        return this.each(function () {
          var o = e(this),
              s = o.data(n),
              a = e.extend({}, r, o.data(), "object" == _typeof(t) && t);
    ...
    modifiers: {
      ...
      computeStyle: {
        ...
        fn: function fn(t, e) {
          ...
          if (g = "bottom" === h ? -l.height + f.bottom : f.top, p = "right" === u ? -l.width + f.right : f.left, s && d) c[d] = "translate3d(" + p + "px, " + g + "px, 0)", c[h] = 0, c[u] = 0, c.willChange = "transform";else {
            var m = "bottom" === h ? -1 : 1,
                v = "right" === u ? -1 : 1;
      ...
      return c.toggle = function (t) {
        ...
        return this.each(function () {
          var r = e(this).data("bs.modal"),
              o = e.extend({}, i.Default, e(this).data(), "object" == _typeof(t) && t);
